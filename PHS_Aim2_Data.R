...
# Primary Outcomes
dat_ihd_ai = create_dat_tab(phs.aim2.data[a2_ihd_post_menop,], "Ischemic Heart Disease", "eoftype", covar_chemo, "ai")
dat_hf_cm_ai = create_dat_tab(phs.aim2.data[a2_hf_cm_post_menop,], "Heart Failure/Cardiomyopathy", "eoftype", covar_chemo, "ai")
dat_stroke_ai = create_dat_tab(phs.aim2.data[a2_stroke_post_menop,], "Stroke", "eoftype", covar_chemo, "ai")

# Tamoxifen (TAM) (pre menopausal women)
dat_ihd_tam = create_dat_tab(phs.aim2.data[a2_ihd_pre_menop,], "Ischemic Heart Disease", "eoftype", covar_chemo, "tam")
dat_hf_cm_tam = create_dat_tab(phs.aim2.data[a2_hf_cm_pre_menop,], "Heart Failure/Cardiomyopathy", "eoftype", covar_chemo, "tam")
dat_stroke_tam = create_dat_tab(phs.aim2.data[a2_stroke_pre_menop,], "Stroke", "eoftype", covar_chemo, "tam")

### Any hormonal therapy
dat_ihd_horm_any = create_dat_tab(phs.aim2.data[a2_ihd,], "Ischemic Heart Disease", "eoftype", covar_chemo, "horm_any")
dat_hf_cm_horm_any = create_dat_tab(phs.aim2.data[a2_hf_cm,], "Heart Failure/Cardiomyopathy", "eoftype", covar_chemo, "horm_any")
dat_stroke_horm_any = create_dat_tab(phs.aim2.data[a2_stroke,], "Stroke", "eoftype", covar_chemo, "horm_any")
